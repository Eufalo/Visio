...
#Método constructor de la clase
	...
	def startDetection(self):
		...
		while True:
			...
			#print(self.videoPanel)
			height, width, channel = frame.shape
			bytesPerLine = channel * width
			image = QImage(frame.data, width, height, bytesPerLine, QImage.Format_RGB)
			self.videoPanel.setPixmap(QPixmap.fromImage(image))
			#self.update()
			#self.videoPanel= QtGui.QImage(frame.data,QtGui.QImage.Format_RGB888)
